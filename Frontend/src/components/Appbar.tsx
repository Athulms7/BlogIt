    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/90 dark:bg-black/70 border-b border-gray-300 dark:border-gray-700 z-50 px-4 py-3 shadow-md flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="font-bold text-2xl text-dark-blue-800">
            BlogIt
          </Link>
        </div>
      ...
      >
        <div className="mt-16 px-6 py-4 space-y-4">
          <Link className="block text-gray-800 dark:text-gray-100 hover:text-gray-500" to="/home" onClick={() => setIsSidebarOpen(false)}>Your Blogs</Link>
          <Link className="block text-gray-800 dark:text-gray-100 hover:text-gray-500" to="/community" onClick={() => setIsSidebarOpen(false)}>Community</Link>

          <Link className="block text-gray-800 dark:text-gray-100 hover:text-gray-500" to="/about" onClick={() => setIsSidebarOpen(false)}>About</Link>
        </div>
      </aside>
